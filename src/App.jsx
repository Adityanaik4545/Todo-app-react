  ...
  <div className="container mx-auto my-4 bg-violet-100 p-5 rounded-2xl min-h-[80vh]">
      ...
      <div className="todos">
        ...
        <div className="btns">
          ...
          <button onClick={handleDelete} className='bg-violet-400 hover:bg-violet-600 hover:text-white px-5 mx-1 rounded-lg transition-all duration-400 font-semibold'>Delete</button>
        </div>
        </div>
        })}
      </div>
